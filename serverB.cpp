...
int main (int argc , char * argv[]){
    ...
    server.sin_port = htons(B_PORT_NUM);
    ...
    cout<<"server B is up and running using UDP on port " << ntohs(server.sin_port)<<endl;
    ...
    while (1){
        ...
        cout << "The Server B has received "<< numberOfElmts << " numbers"<<endl;
        ...
        cout << "The Server B has successfully finished the reduction " << comndString << ": "<<result << endl;
